  ...
  (use-package abbrev
    ...
    (define-abbrev-table 'global-abbrev-table
      '(
        ...
        ("import" "import { @ } from '';" (lambda () (search-backward "@") (delete-char 1)))
        )
      )
    )
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  (use-package company-mode
    ...
    :hook prog-mode
      :init
      (setq company-backends '((company-capf company-abbrev company-dabbrev-code)))
      )
#+END_SRC
** consult
#+BEGIN_SRC emacs-lisp
  (use-package consult
    ...
    :config
    (progn
      (define-key global-minor-mode-map (kbd "C-f") 'consult-line)
      (define-key global-minor-mode-map (kbd "C-x b") 'consult-buffer)
      (define-key global-minor-mode-map (kbd "M-y") 'consult-yank-replace)
      ))
#+END_SRC
** cua-mode
#+BEGIN_SRC emacs-lisp
