...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-agenda-todo-ignore-scheduled 'all
        ...
        '(("y"
           ((agenda "Overview")
            (alltodo ""  ((org-agenda-files (remove "~/Dropbox/todo.work.org" org-agenda-files))
                          (org-agenda-overriding-header "TODO list private:          ")))
            (alltodo "" ((org-agenda-files '("~/Dropbox/todo.work.org"))
...
#+BEGIN_SRC emacs-lisp
  ...
  (setq
        ;; handle html files with multi modes
        mweb-default-major-mode 'web-mode ;;html-mode
        mweb-tags '((php-mode "<\\?php\\|<\\? \\|<\\?=" "\\?>")
                    (js2-mode "<script type=\"text/javascript\"[^>]*>" "</script>")
